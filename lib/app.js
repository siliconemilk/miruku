...
(function() {
  var Character, DialogFactory, Game, GameSession, deinitEdit, disableEdit, disableSubmitOnClick, editMenuDialog, enableEdit, followOnDrag, initEdit, mainMenuDialog, readyEdit, unreadyEdit;
  ...
  initEdit = function() {
    ...
    $(document).on('dialogclose', function(event, ui) {
      return disableEdit(event.target);
    });
