...
(function() {
  var Character, DialogFactory, Game, GameSession, disableEdit, disableSubmitOnClick, enableEdit, followOnDrag, loadMenuDialog, mainMenuDialog, readyEdit;
  ...
  enableEdit = function() {
    ...
    for (_i = 0, _len = elements.length; _i < _len; _i++) {
      ...
      if ($(item).hasClass("editable")) {
        ...
        $(item).next().offset({
          left: $(item).outerWidth() + $(item).offset().left,
          top: $(item).offset().top
        });
  ...
  $(function() {
    ...
    return $(document).on("dialogcreate", readyEdit);
  });
